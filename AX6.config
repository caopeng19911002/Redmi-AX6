...
# CONFIG_FEED_fichenx is not set
...
# CONFIG_PACKAGE_kmod-qca-nss-drv-bridge-mgr-64 is not set
# CONFIG_PACKAGE_kmod-qca-nss-drv-vlan-mgr-64 is not set
...
CONFIG_PACKAGE_luci-app-aliyundrive-webdav-zh-cn=y
